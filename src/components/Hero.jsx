      ...
      <div className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-3xl p-8 lg:p-12 overflow-hidden">
        ...
        <div className="relative grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 text-left">
            <h1 className="text-5xl lg:text-6xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-indigo-800 bg-clip-text text-transparent leading-tight">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/dashboard">
                <Button size="lg" variant="outline" className="border-blue-300 text-blue-700 hover:bg-blue-50 shadow-lg shadow-blue-500/10">
                  Try Demo
                </Button>
              </Link>
            </div>
