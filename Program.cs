    ...
    ITutorRepository tutorRepository) =>
{
    ...
    try
    {
        ...
        // Model comparison requests must not reuse an answer generated by a
        // different model. The normal production path may still use cache.
        if (!hasTutorChatContext && !string.IsNullOrWhiteSpace(q) && string.IsNullOrWhiteSpace(model))
        {
